  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/portfolio" className="card p-6 hover:border-[var(--navy)]">
        ...
        <Link href="/calibration" className="card p-6 hover:border-[var(--navy)]">
          <p className="kicker">Measure → Learn</p>
